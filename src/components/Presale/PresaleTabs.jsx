...
const PresaleTabs = ({ mode,withdrawLoading,setWithdrawLoading,referralCode }) => {
  ...
  const tabContent = [
    <PrivateSale key="privateSale" mode={mode} loading={withdrawLoading} setloading={setWithdrawLoading} referralCode={referralCode} />,
